...
__CONFIG _INTOSC_OSC_NOCLKOUT & _WDTE_OFF & _MCLRE_OFF & _PWRTE_OFF & _BOREN_ON & _LVP_OFF & _CPD_ON & _CP_OFF
...
;    CLRF    TMR1L
    ...
    CLRF    TRISA	    ; SET RA0..7 to Output (LEDs)
    MOVLW   0x03
    MOVWF   TRISB	    ; SET RB0..1 to Input (Interrupt & Tilt Switch)
