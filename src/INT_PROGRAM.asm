...
Init
    ...
    MOVLW   0x01	    ; SET RB1...7 to OUTPUT, RB0 to INPUT
    CLRF    TRISB	    ; SET RB1...7 to OUTPUT (LED output)
...
LoopMessage
    ...
    ; extra porta as output (if interrupt program)
    BTFSS   W, 0
    BCF	    PORTA, 0
    BTFSC   W, 0
    BSF	    PORTA, 0
